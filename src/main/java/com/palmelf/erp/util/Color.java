...
public enum Color {
    ...
    APRICOT("杏色","A"),PURPLE("紫色","PU"),ORANGE("橘色","O"),SILVER("银色","S"),COFFEE("咖啡色","CO"),BROWN("棕色","BR"),BLACK_WHITE("黑白条纹","BW"),ROSE_RED("玫红色","RR"),
    LAKE_BLUE("湖蓝色","LB"),PASTEL_PINK("淡粉色","PP"), DARK_BROWN("深棕色","DBR"), DARK_GRAY("深灰色","DGR"),SKYBLUE("天蓝色","SB"),WHEAT("土黄色","WH"),GOLD("金色","GO"),
    DARK_BLUE("深蓝色","DBL"),LIGHT_BLUE("浅蓝色","LBL"),KHAKI("卡其","K"),CAMEL("驼色","CA"),WINE_RED("酒红色","WR"),WATERMELON_RED("西瓜红","WRE"),DARK_RED("枣红色","DR"),
